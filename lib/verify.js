 ...
 */
function verify(message, isDns, callback) {
  ...
  function verifyNextSignature() {
    ...
    DKIM.verifySignature(body, headers, isDns, function (error, result) {
 ...
 */
verify.filterSignatureHeaders = function filterSignatureHeaders(
  headers,
  signatureHeader
) {
